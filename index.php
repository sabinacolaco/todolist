...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <p>The secret of getting ahead is doing your task on time :)</p>
            <div class="row mb-20">
                <div class="col-lg-12">
                    ...
                    if (!empty($rows)) {
                        ...
                        foreach ($rows as $k=>$v) {        
                            ...
                            <tr>
                                <td><?=$i;?></td>
                                <td><?=$v['task'];?></td>
                                <td><?=date('H:i A', strtotime($v['due_date']));?></td>
                                <td>
            ...
            <div class="modal-content">
                ...
                <form id ="addform">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success submitBtn" id="submit" value="submit">Submit</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="deleteModal" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-success delete" id="confirm-button">Yes</button>
                </div>
            </div>
        </div>
    </div>
